...
/**
 * ReversoDebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf
 */

public class ReversoDebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf {
  ...
  public ReversoDebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf() {
  }

  public ReversoDebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf orgnlMsgId(@Nonnull String orgnlMsgId) {
  ...
  public ReversoDebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf orgnlMsgNmId(
      @Nonnull String orgnlMsgNmId) {
  ...
  public ReversoDebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf orgnlCreDtTm(
      @Nonnull String orgnlCreDtTm) {
