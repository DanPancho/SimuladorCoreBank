...
/**
 * ReversoDebitoDocumentHeader
 */

public class ReversoDebitoDocumentHeader {
  ...
  @Valid
  private ReversoDebitoDocumentHeaderOrigId origId;
  ...
  @NotNull(message = "REQUEST NO VALIDO, FALTAN CAMPOS MANDATORIOS")
  @Valid
  private ReversoDebitoDocumentHeaderMge mge;
  ...
  public ReversoDebitoDocumentHeader() {
  }

  public ReversoDebitoDocumentHeader origId(@Nonnull ReversoDebitoDocumentHeaderOrigId origId) {
    this.origId = origId;
    return this;
  }
   ...
   */
  @Nonnull
  public ReversoDebitoDocumentHeaderOrigId getOrigId() {
    return origId;
  }

  public void setOrigId(@Nonnull ReversoDebitoDocumentHeaderOrigId origId) {
    this.origId = origId;
  }


  public ReversoDebitoDocumentHeader sender(@Nonnull String sender) {
    this.sender = sender;
    return this;
  }
  ...
  public ReversoDebitoDocumentHeader receiver(@Nonnull String receiver) {
  ...
  public ReversoDebitoDocumentHeader mge(@Nonnull ReversoDebitoDocumentHeaderMge mge) {
    this.mge = mge;
    return this;
  }
   ...
   */
  @Nonnull
  public ReversoDebitoDocumentHeaderMge getMge() {
    return mge;
  }

  public void setMge(@Nonnull ReversoDebitoDocumentHeaderMge mge) {
    this.mge = mge;
  }


  public ReversoDebitoDocumentHeader pssblDplct(@Nonnull String pssblDplct) {
  ...
  public ReversoDebitoDocumentHeader prty(@Nonnull String prty) {
    this.prty = prty;
    return this;
  }
