...
/**
 * ReversoDebitoDocumentFIToFIDbtPmtRvslTxInfOrgnlGrpInf
 */

public class ReversoDebitoDocumentFIToFIDbtPmtRvslTxInfOrgnlGrpInf {
  ...
  public ReversoDebitoDocumentFIToFIDbtPmtRvslTxInfOrgnlGrpInf() {
  }

  public ReversoDebitoDocumentFIToFIDbtPmtRvslTxInfOrgnlGrpInf orgnlMsgId(@Nonnull String orgnlMsgId) {
  ...
  public ReversoDebitoDocumentFIToFIDbtPmtRvslTxInfOrgnlGrpInf orgnlMsgNmId(@Nonnull String orgnlMsgNmId) {
  ...
  public ReversoDebitoDocumentFIToFIDbtPmtRvslTxInfOrgnlGrpInf orgnlCreDtTm(@Nonnull String orgnlCreDtTm) {
