...
/**
 * CreditoRequestDocumentHeaderOrigIdService
 */

public class CreditoRequestDocumentHeaderOrigIdService {
  ...
  public CreditoRequestDocumentHeaderOrigIdService() {
  }

  public CreditoRequestDocumentHeaderOrigIdService idServ(@Nonnull String idServ) {
    this.idServ = idServ;
    return this;
  }
  ...
  public CreditoRequestDocumentHeaderOrigIdService versServ(@Nonnull String versServ) {
