...
/**
 * CreditoRequestDocumentFIToFICstmrCdtTrfCdtTrfTxInfPmtId
 */

public class CreditoRequestDocumentFIToFICstmrCdtTrfCdtTrfTxInfPmtId {
  ...
  public CreditoRequestDocumentFIToFICstmrCdtTrfCdtTrfTxInfPmtId() {
  }

  public CreditoRequestDocumentFIToFICstmrCdtTrfCdtTrfTxInfPmtId endToEndId(@Nonnull String endToEndId) {
  ...
  public CreditoRequestDocumentFIToFICstmrCdtTrfCdtTrfTxInfPmtId txId(@Nonnull String txId) {
    this.txId = txId;
    return this;
  }
