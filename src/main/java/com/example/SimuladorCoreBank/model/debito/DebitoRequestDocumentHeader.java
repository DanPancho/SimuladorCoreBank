...
/**
 * DebitoRequestDocumentHeader
 */

public class DebitoRequestDocumentHeader {
 ...
 @JsonProperty(SERIALIZED_NAME_MGE)
  ...
  @NotNull(message = "REQUEST NO VALIDO, FALTAN CAMPOS MANDATORIOS")
  @Valid
  private DebitoRequestDocumentHeaderMge mge;
 ...
 @JsonProperty(SERIALIZED_NAME_PRTY)
  ...
  public DebitoRequestDocumentHeader() {
  }

  public DebitoRequestDocumentHeader origId(@Nonnull DebitoRequestDocumentHeaderOrigId origId) {
    this.origId = origId;
    return this;
  }
  ...
  public DebitoRequestDocumentHeader sender(@Nonnull String sender) {
    this.sender = sender;
    return this;
  }
  ...
  public DebitoRequestDocumentHeader receiver(@Nonnull String receiver) {
  ...
  public DebitoRequestDocumentHeader mge(@Nonnull DebitoRequestDocumentHeaderMge mge) {
    this.mge = mge;
    return this;
  }
   ...
   */
  @Nonnull
  public DebitoRequestDocumentHeaderMge getMge() {
    return mge;
  }

  public void setMge(@Nonnull DebitoRequestDocumentHeaderMge mge) {
    this.mge = mge;
  }


  public DebitoRequestDocumentHeader pssblDplct(@Nonnull String pssblDplct) {
  ...
  public DebitoRequestDocumentHeader prty(@Nonnull String prty) {
    this.prty = prty;
    return this;
  }
