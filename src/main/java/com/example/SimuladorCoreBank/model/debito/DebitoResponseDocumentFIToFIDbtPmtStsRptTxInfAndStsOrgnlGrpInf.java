...
/**
 * DebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf
 */

public class DebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf {
 ...
 @JsonProperty(SERIALIZED_NAME_ORGNL_CRE_DT_TM)
  ...
  public DebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf() {
  }

  public DebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf orgnlMsgId(@Nonnull String orgnlMsgId) {
  ...
  public DebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf orgnlMsgNmId(@Nonnull String orgnlMsgNmId) {
  ...
  public DebitoResponseDocumentFIToFIDbtPmtStsRptTxInfAndStsOrgnlGrpInf orgnlCreDtTm(@Nonnull String orgnlCreDtTm) {
